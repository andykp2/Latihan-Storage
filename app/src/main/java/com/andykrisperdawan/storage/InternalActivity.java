...
public class InternalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtIsiFile = findViewById(R.id.txt_isifile);
        edtText = findViewById(R.id.edt_isi);
    ...
    public void actionBuat(View view) {
    ...
    public void actionUbah(View view) {
    ...
    public void actionBaca(View view) {
    ...
    public void actionHapus(View view) {
        File file = new File(getFilesDir(), FILE_NAME);
        if (file.exists()) {
            file.delete();
        }
